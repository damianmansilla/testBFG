var handler = new OpenmixApplication({
     ...
     */
    providers: {
        'edgecast': { 'cname': 'cs205.wac.deltacdn.net', 'padding': 0, 'penal': false },
        'level3_optimicdn': { 'cname': 'optimicdn.com.c.footprint.net', 'padding': 0, 'penal': false },
...
function OpenmixApplication(settings) {
    ...
    var aliases = settings.providers === undefined ? [] : Object.keys(settings.providers),
        allReasons = { best_performing: 'A', data_problem: 'B', asn_override: 'C' };
    ...
    this.handle_request = function(request, response) {
        ...
        */
        ...
        if (settings.asn_override[asn] !== undefined) {
            decisionProvider = settings.asn_override[asn];
